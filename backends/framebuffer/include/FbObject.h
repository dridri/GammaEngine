...
{
public:
	FbObject( VertexBase* verts = nullptr, uint32_t nVerts = 0, uint32_t* indices = nullptr, uint32_t nIndices = 0 );
	FbObject( const std::string filename, Instance* instance = nullptr );
	~FbObject();
